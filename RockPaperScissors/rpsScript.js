...
playerChoiceRock.addEventListener("click",()=>{playerChoiceRock.style.border="2px grey solid";setTimeout(()=>{playerChoiceRock.style.border="none";},200)});
...
playerChoicePaper.addEventListener("click",()=>{playerChoicePaper.style.border="2px grey solid";setTimeout(()=>{playerChoicePaper.style.border="none";},200)});
...
playerChoiceScissors.addEventListener("click",()=>{playerChoiceScissors.style.border="2px grey solid";setTimeout(()=>{playerChoiceScissors.style.border="none";},200)});
